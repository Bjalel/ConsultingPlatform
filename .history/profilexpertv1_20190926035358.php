         ...
         <nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="background-color: #212529 !important ; ">
                ...
                <div class="row" style="padding-top: 10px">
                      <div class="col-sm-3"><!--left col-->
                        ...
                        <div class="card">
                        <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="rounded-circle" alt="avatar" height="100" width="100">
                          <h1>houssem jraidi</h1>
                                ...
                                <table class="table">
                                        ...
                                        <tbody >
                                          <tr ng-repeat="item in forum">
                                            ...
                                            <td>{{item.sujet}}</td>
                                            <td>8-7-2019</td>
                                            <td> <button class="btn-success"> Répondre </button> </td>
