...
<body ng-app="aa" >
                ...
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark" >
                      ...
                      <ul class="navbar-nav" id="myTab" >
                        ...
                        <li class="nav-item"><a href="#13" class="nav-link" style="color: #ffffff ;font-family: 'Agency FB Bold', arial ;padding-left:10px" data-toggle="tab">nv contact</a></li>
                        <div class="d-flex justify-content-center h-100">
                          ...
                          <div  style="right:10px  !important ">
                              <ul class="navbar-nav" >
                                  ...
                                  <li class="nav-item">
                                    <a href="#MyModal" data-toggle="modal"  class="nav-link" style="color: #ffffff ;font-family: 'Agency FB Bold', arial" >Déconnexion</a>
                                  </li>
                              </ul>
                            </div>
                </nav>
                   ...
                   <div class="row" style="padding-top: 10px"> 
                          ...
                          <div class="card"  >
                                <div class="text-center">
                                    <h6>Nom Client</h6>
                                  <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="rounded-circle" alt="avatar" height="50" width="50">
                                 
                                </div>
                                     <a href="#14" data-toggle="tab" ><h6> profil </h6></a>
                                    <a href="#15" data-toggle="tab"><h6>Modifier profil</h6></a>
                      ...
                      <!--contenue page 1 -->   
                                    ...
                                    <ul class="nav nav-tabs" id="myTab">
                                        <li class="active"><a href="#1" data-toggle="tab" style="font-family: 'Agency FB Bold';padding-left:380px" >All</a></li>
                                        <li><a href="#2" data-toggle="tab" style="margin-left:30px;font-family: 'Agency FB Bold' ">Nutrition</a></li>
                                        <li><a href="#3" data-toggle="tab"  style="margin-left:30px;font-family: 'Agency FB Bold' ">Droit</a></li>
                                    </ul>
                             ...
                             <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="1">    
                                                <div class="grid-container" ng-controller="Control">
                                                        <div class="grid-item" ng-repeat="item in expert  ">
                                                      <div class="card">
                                                        
                                                        <img  src="img/{{item.id_expert}}.jpg" alt="John" height="200" width="250" >
                                                        ...
                                                        <p ><button  ng-click="fonction(item.nom_exp)">Contact</button></p>
                        ...
                        <div class="tab-pane " id="12">   
                                   <ul class="nav nav-tabs" id="myTab">
                                        <li class="active"><a href="#5" data-toggle="tab" style="margin-left:30px;font-family: 'Agency FB Bold' ">Nouveau contact</a></li>
                                        <li><a href="#6" data-toggle="tab" style="margin-left:30px;font-family: 'Agency FB Bold' ">boite</a></li>
                                    </ul>
                                      <div class="tab-content">
                                                                        ...
                                                                        <div class="basic-form">
                                                                            <form>
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control input-default" placeholder="Sujet">
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="basic-form">
                                                                    <form>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <p align="right" >
                                                                                    <button class="btn btn-success" ><b>Envoyer</b></button>
                                                                                  </p>
                                                                        </div>
                                        ...
                                        <div class="tab-pane " id="6">    
                                                <table class="table table-striped table-hover" ng-controller="listmsg" >
                                                        <thead>
                                                            <tr>
                                                                <th>Etat</th>
                                                                <th>sender</th>
