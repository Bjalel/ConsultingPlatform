...
<div class="jumbotron text-center" style="margin-bottom:0 ; background-color: white ;margin-bottom: -60px ;margin-top: -50px; ">
        <h1 style="font-weight: bold;font-size: 45pt;font-family: 'Agency FB Bold', arial ;text-shadow: 4px 4px 4px #aaa; ">Resolu page admin</h1>
 ...
 <div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="post" action="cnadmin.php">
