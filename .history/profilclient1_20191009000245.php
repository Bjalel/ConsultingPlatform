...
<body ng-app="aa" ng-controller="Control" >
                ...
                <nav class="navbar navbar-expand-sm bg-dark navbar-dark" >
                      ...
                      <ul class="navbar-nav" id="myTab" >
                        ...
                        <li class="nav-item"><a href="#16" class="nav-link" style="color: #ffffff ;font-family: 'Agency FB Bold', arial ;padding-left:10px" data-toggle="tab">Contacter Expert</a></li>
